![Android CI](https://github.com/godot-mobile-plugins/godot-deeplink/actions/workflows/android-ci.yml/badge.svg)
![iOS CI](https://github.com/godot-mobile-plugins/godot-deeplink/actions/workflows/ios-ci.yml/badge.svg)

# <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="28"> Contributing

Thank you for your interest in contributing to the Godot Deeplink Plugin! This guide will help you understand the project structure, build processes, and development workflows.

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Table of Contents
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Project structure
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Build System Architecture
...
println(pluginConfig.pluginName)        // "DeeplinkPlugin"
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Prerequisites
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="20"> Common Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="20"> Build Customization
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="20"> Local Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="20"> iOS Configuration
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Development Workflow

### Initial Setup

1. **Clone the repository:**
   ```bash
   git clone https://github.com/godot-mobile-plugins/godot-deeplink.git
   cd godot-deeplink
   ```
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Building
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="20"> Cross-Platform Builds
...
- **Release archive:** `release/DeeplinkPlugin-*-v*.zip`

---

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="20"> Android Builds
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="20"> iOS Builds
...
- **Plugin XCFrameworks:** `ios/build/framework/DeeplinkPlugin.debug.xcframework`, `DeeplinkPlugin.release.xcframework`
- **Release archive:** `release/DeeplinkPlugin-iOS-v*.zip`
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Code Formatting
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Testing
...
|------|----------|---------|
| `DeeplinkTests.swift` | Swift | `Deeplink` class — init, `isActiveKey`, `onThisHappened` callback, ObjC bridging, concurrency |
| `DeeplinkLoggerTests.mm` | Objective-C++ | `deeplink_log` global — initialization, all log levels, format string handling |

The tests are compiled into the `deeplink_plugin_tests` Xcode test bundle target, which declares a dependency on the main `deeplink_plugin` static library target. The Xcode scheme used by the build system is `deeplink_plugin_tests`.
...
| Concern | Detail |
|---------|--------|
| Target name | `deeplink_plugin_tests` |
| Product type | `com.apple.product-type.bundle.unit-test` |
| Scheme file | `ios/plugin.xcodeproj/xcshareddata/xcschemes/deeplink_plugin_tests.xcscheme` |
| Linked library | `libdeeplink_plugin.a` (the main plugin target) |
| Target dependency | `deeplink_plugin` (built before tests run) |
| Header search paths | `$(SRCROOT)/src`, `$(CONFIGURATION_TEMP_DIR)/deeplink_plugin.build/DerivedSources` |

#### Writing new iOS tests

Swift tests: add a new `XCTestCase` subclass to `ios/test/unit/` and register the file in the `deeplink_plugin_tests` target's Sources build phase in `project.pbxproj`.

Objective-C++ tests: add a `.mm` file to `ios/test/unit/`. Import `deeplink_logger.h` for logger access or `deeplink_plugin.h` for the plugin class. Add the file to the Sources build phase the same way.

> **Note on Godot engine classes:** `DeeplinkPlugin` (the `Object` subclass), `deeplink_plugin_init()`, and `deeplink_plugin_deinit()` all depend on `memnew`/`memdelete` and `Engine::get_singleton()`, which are Godot engine internals unavailable in a plain XCTest host. Test those paths using GDScript integration tests via the Godot editor or the [GUT](https://github.com/bitwes/Gut) framework instead.
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Creating Releases
...
This creates:
- `release/DeeplinkPlugin-Android-v*.zip`
- `release/DeeplinkPlugin-iOS-v*.zip`
- `release/DeeplinkPlugin-Multi-v*.zip` (combined)
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> GitHub Actions Workflows
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Installation

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="20"> Installing to Demo App
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="20"> Installing to Your Project

```bash
# Using install script
./script/install.sh -t /path/to/your/project -z /path/to/DeeplinkPlugin-*.zip

# Example
./script/install.sh -t ~/MyGame -z release/DeeplinkPlugin-Multi-v6.0.zip
```

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Troubleshooting
...
#   ios/plugin.xcodeproj/xcshareddata/xcschemes/deeplink_plugin_tests.xcscheme
# and the test target must be listed in the targets array of project.pbxproj.
# Verify both are present:
find ios/plugin.xcodeproj -name "deeplink_plugin_tests.xcscheme"
grep "deeplink_plugin_tests" ios/plugin.xcodeproj/project.pbxproj
```

**Problem:** iOS tests fail with "module not found" or linker errors
```bash
# The test target links against libdeeplink_plugin.a.
...
```bash
# Tests that exercise DeeplinkPlugin (the Godot Object subclass) or the
...
- Check existing [GitHub Issues](https://github.com/godot-mobile-plugins/godot-deeplink/issues)
- Check exısting [GitHub Discussions](https://github.com/godot-mobile-plugins/godot-deeplink/discussions)
- Review [Godot documentation](https://docs.godotengine.org/)

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Contributing Guidelines
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-deeplink/main/addon/src/main/icon.png" width="24"> Additional Resources
